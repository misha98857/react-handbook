...
export const initApplicationDataAction = createAction(
  '[Settings Module] initApplicationDataAction',
  props<{
...
export const toggleNavigationButtonAction = createAction(
  '[Settings Module] toggleNavigationButtonAction',
  props<{
    navButton: boolean;
  }>(),
);
...
export const changeAppLanguageAction = createAction(
  '[Settings Module] toggleAppLanguageAction',
  props<{
    language: string;
  }>(),
);
...
export const toggleRestoreStateAction = createAction(
  '[Settings Module] changeRestoreStateAction',
  props<{
